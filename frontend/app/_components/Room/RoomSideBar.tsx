...
import { useRoom } from "_services/contexts/RoomContext";
...
function RoomSideBar() {
  ...
  return (
    <div className="overflow-y-scroll w-20 h-screen border-r-2 sm:w-1/4">
      ...
      <div
        className="flex justify-center items-center p-1 m-2 rounded-lg border-2 cursor-pointer text-white border-primary bg-primary hover:bg-secondary hover:text-white"
